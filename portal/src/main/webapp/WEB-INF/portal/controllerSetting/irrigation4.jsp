...
function changeController(){
	...
	window.location.href="/controllerSetting/toIrrigation4.do?controllerId="+controllerId;
}
function topage(i){
...
<body >
<form action="/controllerSetting/updateIrrigation4.do" method="post">
		...
		<div style="float: left;font-size: 20px;margin: 20px;">
			<table cellspacing="5" cellpadding="1" border="0"  style="font-size: 20px;background-color: #F0F7FD;margin: 0 auto">
				<tr>
					...
					<td align="center"><input type="button" onclick="topage(4)" value="4#灌溉阀" disabled="disabled"/></td>
